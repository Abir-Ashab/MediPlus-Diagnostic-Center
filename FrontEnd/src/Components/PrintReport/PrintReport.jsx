    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="patient-left">
          ...
          <strong>Sex : ${order.gender}</strong>
          </div>
        ...
        <tbody>
          ...
          // Get the display name from TestCategories mapping, fallback to formatted category name
          ...
          return categoryTests.map((test, index) => {
            if (index === 0) {
            // First test in category - show group name
            return `
              <tr class="test-row">
            ...
            // Subsequent tests in same category
            return `
              <tr class="test-row">
              <td class="test-name-col">${test.testName}</td>
              <td class="price-col">${test.testPrice}.00</td>
        ...
        <div class="totals-box">
          ...
          <div class="total-line"><strong>Advance :</strong> ${order.totalAmount}.00</div>
          <div class="total-line"><strong>Due :</strong> 0.00</div>
