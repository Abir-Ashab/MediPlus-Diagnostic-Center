  ...
  return (
    <div className="space-y-8">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className="bg-white/20 hover:bg-white/30 border-0 text-white rounded-lg h-8 px-3"
                    //   icon={<Edit className="w-3 h-3" />}
                    >
                      {useManualTotal ? 'Auto' : 'Edit'}
                    </Button>
                  </div>
                  {useManualTotal && (
                    <Input
                      ...
                      className="mt-3 bg-white/20 border-white/30 text-white placeholder-blue-200"
                      min="0"
                    />
                  )}
                </div>
      ...
      <div >
        {/* Appointment Summary */}
        {/* {commonData.doctorName && (
          <Card className="shadow-lg border-0 bg-gradient-to-br from-blue-50 via-white to-purple-50/30 overflow-hidden">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Consultation booking details</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                {[
                  ...
                  { label: 'Doctor', value: commonData.doctorName, color: 'text-blue-600' },
                  { label: 'Date & Time', value: `${appointmentData.date} at ${appointmentData.time}`, color: 'text-gray-700' },
                  { label: 'Consultation Fee', value: `৳${appointmentData.doctorFee || 0}`, color: 'text-purple-600' },
              ...
              <Button
                ...
                className="w-full h-14 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 border-0 text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
                loading={loading}
                icon={<Calendar className="w-5 h-5" />}
              >
                {loading ? 'Booking Appointment...' : 'Book Appointment Only'}
              </Button>
            </div>
          </Card>
        )} */}
      ...
      {commonData.doctorName && selectedTests.some(test => test.testId !== "") && (
        <div className="flex justify-center">
          <Button
            ...
            disabled={loading || !appointmentData.time || !testData.date}
            className="h-16 px-12 rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 border-0 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
            loading={loading}
            size="large"
          >
            <div className="flex items-center gap-3">
              ...
              <span>{loading ? 'Processing...' : 'Book Appointment & Create Test Order'}</span>
            </div>
          </Button>
        </div>
      )} */}
